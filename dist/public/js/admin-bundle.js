...
class App extends React.Component {
    ...
    deleteProduct() {
        return __awaiter(this, void 0, void 0, function* () {
            const id = this.state.products[this.state.productToDelete]._id;
            try {
    ...
    handleChangeOrderState(orderState) {
    ...
    handlePrintSummary(e) {
        const printableSummmary = e.currentTarget.parentElement;
    ...
    handleReorder() {
        ...
        if (this.state.orderSystem === 0) {
            ...
            data.sort((a, b) => (a.dateCreated.toLowerCase().localeCompare(b.dateCreated.toLowerCase())));
    ...
    handleSerachByTitle(title) {
        const data = this.state.products;
        if (title) {
            let newData = [];
            for (let i = 0; i < data.length; i++) {
                if (data[i].title.toLowerCase().indexOf(title.toLocaleLowerCase()) > -1) {
                    newData.push(data[i]);
                }
            }
            this.handlePageData(newData);
...
/***/ "./src/public/tsx/components/DeleteModal.tsx":
/*!***************************************************!*\
  !*** ./src/public/tsx/components/DeleteModal.tsx ***!
  \***************************************************/
/*! no static exports found */
...
class DeleteModal extends React.Component {
    ...
    render() {
        return (this.props.showDeleteModal ?
            React.createElement("div", { className: "modal", id: "deleteModal", role: "dialog" },
                React.createElement("div", { className: "modal-dialog", role: "document" },
                    React.createElement("div", { className: "modal-content" },
                        React.createElement("div", { className: "modal-header" },
                            React.createElement("h5", { className: "modal-title" }, "Vymazať produkt: " + this.props.products[this.props.productToDelete].title),
                            React.createElement("button", { type: "button", className: "close", "data-dismiss": "modal", "aria-label": "Close" },
                                React.createElement("span", { "aria-hidden": "true" }, "\u00D7"))),
                        React.createElement("div", { className: "modal-body" },
                            React.createElement("p", null, "Naozaj chceš vymazať " + this.props.products[this.props.productToDelete].title + "?")),
                        React.createElement("div", { className: "modal-footer" },
                            React.createElement("button", { type: "button", className: "btn btn-secondary", "data-dismiss": "modal", onClick: this.props.closeDeleteModal }, "Zatvori\u0165"),
                            React.createElement("button", { type: "button", className: "btn btn-danger", onClick: this.props.deleteProduct }, "Vymaza\u0165"))))) : null);
    }
}
...
class Modal extends React.PureComponent {
    ...
    render() {
        return (this.props.modalText ?
            React.createElement("div", { className: "modal", id: "commonModal", role: "dialog" },
                React.createElement("div", { className: "modal-dialog", role: "document" },
                    React.createElement("div", { className: "modal-content" },
                        React.createElement("div", { className: "modal-header" },
...
const OrderManagerModal = (props) => {
    const { handleChangeOrderDeliveryTime, handleChangeOrderState, handleOrderStateUpdate, handlePrintSummary, orderManagerOpen, orderState, oldOrderState, order, orderDeliveryTime, printData, showOrderSucess, } = props;
    const date = new Date();
                    ...
                    React.createElement("div", { className: "modal-body" },
                        React.createElement("div", { className: "row" },
                            React.createElement("div", { className: "col-12" },
                                React.createElement("div", { className: "printable-summary position-relative" },
                                    React.createElement("h6", null, "S\u00FAhrn objedn\u00E1vky:"),
                                    React.createElement("p", { className: printData ? "" : "d-none" },
                                        "\u010C\u00EDslo objedn\u00E1vky: ",
                                        React.createElement("strong", null, order.orderNum)),
                                    React.createElement("button", { type: "button", className: "btn btn-outline-info position-absolute", style: {
                                            top: 0,
                                            right: 0,
                                            fontSize: "x-small",
                                    ...
                                    React.createElement("table", { className: "table table-striped table-bordered mt-3" },
                                        React.createElement("thead", null,
                                            React.createElement("tr", null,
                                                React.createElement("th", { scope: "col" }, "#"),
                                                React.createElement("th", { scope: "col" }, "N\u00E1zov produktu"),
                                                React.createElement("th", { scope: "col" }, "Typ"),
                                                React.createElement("th", { scope: "col" }, "Balen\u00E9 po."),
                                                React.createElement("th", { scope: "col" }, "Ve\u013Ekos\u0165 krabice"),
                                                React.createElement("th", { scope: "col" }, "Po\u010Det krab\u00EDc"))),
                                        React.createElement("tbody", null, order.products.map((item, i) => {
                                            const sterility = item.isSterile ? "Sterilné" : "Nesterilné";
                                            return (React.createElement("tr", { key: i + 1 },
                                                React.createElement("td", { scope: "row" }, i + 1),
                                                React.createElement("td", null, item.title),
                                                React.createElement("td", null, sterility),
                                    ...
                                    React.createElement("div", { className: "row border pt-2", style: { marginLeft: 0, marginRight: 0 } },
                                        React.createElement("div", { className: "col-6" },
                                            React.createElement("p", null,
                                                React.createElement("strong", null, "Objedn\u00E1vate\u013E:"),
                                                ` ${order.name},`,
                                                React.createElement("br", null),
                                                React.createElement("strong", null, "Telef\u00F3n:"),
                                                ` ${order.phone},`,
                                                React.createElement("br", null),
                                                React.createElement("strong", null, "E-mail:"),
                                                ` ${order.email},`),
                                            React.createElement("p", { className: "border-top" },
                                                React.createElement("strong", null, "Faktura\u010Dn\u00E1 adresa:"),
                                                React.createElement("br", null),
                                                React.createElement("strong", null, "Ulica"),
                                                ` ${order.billingAddress.street}`,
                                                React.createElement("br", null),
                                                React.createElement("strong", null, "PS\u010C"),
                                                ` ${order.billingAddress.psc}`,
                                                React.createElement("br", null),
                                                React.createElement("strong", null, "Mesto"),
                                                ` ${order.billingAddress.city}`),
                                            order.deliveryAddress.city ?
                                                (React.createElement("p", { className: "border-top" },
                                                    React.createElement("strong", null, "Doru\u010Dovacia adresa:"),
                                                    React.createElement("br", null),
                                                    React.createElement("strong", null, "Ulica"),
                                                    ` ${order.deliveryAddress.street}`,
                                                    React.createElement("br", null),
                                                    React.createElement("strong", null, "PS\u010C"),
                                                    ` ${order.deliveryAddress.psc}`,
                                                    React.createElement("br", null),
                                                    React.createElement("strong", null, "Mesto"),
                                                    ` ${order.deliveryAddress.city}`)) : null),
                                        React.createElement("div", { className: "col-6" },
                                            order.company ? React.createElement("p", null,
                                                React.createElement("strong", null, "Spolo\u010Dnos\u0165:"),
                                                ` ${order.company}`) : null,
                                            order.ico ? React.createElement("p", null,
                                                React.createElement("strong", null, "I\u010CO:"),
                                                ` ${order.ico}`) : null))))),
                        order.message ?
                            React.createElement("p", { className: "mt-2 pb-2 border-bottom" },
                                React.createElement("strong", null, "Spr\u00E1va od z\u00E1kazn\u00EDka:"),
                                React.createElement("br", null),
                                ` ${order.message}`) : null,
                        React.createElement("div", { className: "row mt-3" },
                            React.createElement("div", { className: "col-12" },
                                React.createElement("h6", null, "Spr\u00E1va objedn\u00E1vky:"),
                                React.createElement("form", { onSubmit: (e) => handleOrderStateUpdate(e) },
                                    React.createElement("div", { className: "row" },
                                        React.createElement("div", { className: "col-6" },
                                            React.createElement("div", { className: "form-group" },
                                                React.createElement("label", { htmlFor: "state" }, "Stav objedn\u00E1vky"),
                                                React.createElement("select", { className: "form-control", id: "state", name: "state", onChange: (e) => {
                                                        const currentOrderState = e.target.selectedIndex;
                                                        handleChangeOrderState(currentOrderState);
                                                    }, value: orderState, disabled: order.state > 1 ? true : false },
                                                    React.createElement("option", { value: "0", disabled: true }, "Nov\u00E1 objedn\u00E1vka"),
                                                    React.createElement("option", { value: "1", disabled: order.state == 1 ? true : false }, "Vybavuje sa"),
                                                    React.createElement("option", { value: "2", disabled: order.state == 2 ? true : false }, "Vybaven\u00E1"))),
                                            orderState > 0 ?
                                                (orderState < 2 ?
                                                    (React.createElement("div", { className: "form-group" },
                                                        React.createElement("label", { htmlFor: "deliveryTime" }, "Vybavenie objedn\u00E1vky do:"),
                                                        React.createElement("select", { className: "form-control", id: "deliveryTime", name: "deliveryTime", onChange: (e) => {
                                                                const orderDeliveryTime = e.currentTarget.selectedIndex;
                                                                handleChangeOrderDeliveryTime(orderDeliveryTime);
                                                            }, value: orderDeliveryTime },
                                                            React.createElement("option", { value: "0" }, "5. prac. dn\u00ED"),
                                                            React.createElement("option", { value: "1" }, "10. prac. dn\u00ED"),
                                                            React.createElement("option", { value: "2" }, "15. prac. dn\u00ED"),
                                                            React.createElement("option", { value: "3" }, "20. prac. dn\u00ED"),
                                                            React.createElement("option", { value: "4" }, "viac ako 20. prac. dn\u00ED")))) : null) : null),
                                        React.createElement("div", { className: "col-6 pt-1" }, orderState > 0 ?
                                            (orderState < 2 ?
                                                (orderDeliveryTime > 0 ?
                                                    (orderDeliveryTime > 1 ?
                                                        (orderDeliveryTime > 2 ?
                                                            (orderDeliveryTime > 3 ?
                                                                React.createElement("p", { className: "text-danger" },
                                                                    "Doda\u0165 objedn\u00E1vku za viac ako 20. prac. dn\u00ED, odo d\u0148a ",
                                                                    React.createElement("strong", null, orderMDate ? orderMDate : clientDate),
                                                                    ".") :
                                                                React.createElement("p", { className: "text-danger" },
                                                                    "Z\u00E1v\u00E4zne doda\u0165 objedn\u00E1vku do 20. prac. dn\u00ED, odo d\u0148a ",
                                                                    React.createElement("strong", null, orderMDate ? orderMDate : clientDate),
                                                                    ".")) : React.createElement("p", { className: "text-danger" },
                                                            "Z\u00E1v\u00E4zne doda\u0165 objedn\u00E1vku do 15. prac. dn\u00ED, odo d\u0148a ",
                                                            React.createElement("strong", null, orderMDate ? orderMDate : clientDate),
                                                            ".")) : React.createElement("p", { className: "text-danger" },
                                                        "Z\u00E1v\u00E4zne doda\u0165 objedn\u00E1vku do 10. prac. dn\u00ED, odo d\u0148a ",
                                                        React.createElement("strong", null, orderMDate ? orderMDate : clientDate),
                                                        ".")) : React.createElement("p", { className: "text-danger" },
                                                    "Z\u00E1v\u00E4zne doda\u0165 objedn\u00E1vku do 5. prac. dn\u00ED, odo d\u0148a ",
                                                    React.createElement("strong", null, orderMDate ? orderMDate : clientDate),
                                                    ".")) : React.createElement("p", { className: "text-success" }, "Objedn\u00E1vka je vybaven\u00E1.")) : null)),
                                    React.createElement("div", { className: "row" },
                                        React.createElement("div", { className: "col-6" },
                                            React.createElement("div", { className: "form-group" },
                                                React.createElement("label", { htmlFor: "message" }, "Spr\u00E1va pre z\u00E1kazn\u00EDka:"),
                                                React.createElement("p", null,
                                                    React.createElement("i", null,
                                                        React.createElement("small", null, `Dobrý deň pán/pani ${order.name}`))),
                                                React.createElement("textarea", { "aria-describedby": "messageHelp", className: "form-control", id: "message", name: "message", rows: 6, onFocus: () => handleChangeOrderState(-1), onBlur: () => {
                                                        console.log("Lost focus");
                                                        handleChangeOrderState(oldOrderState);
                                                    }, placeholder: "Sem nap\u00ED\u0161 spr\u00E1vu o stave objedn\u00E1vky, ktor\u00E1 bude odoslan\u00E1 z\u00E1kazn\u00EDkovi.\n\nVyplnen\u00EDm tohto textov\u00E9ho po\u013Ea, bud\u00FA predo\u0161l\u00E9 inform\u00E1cie o \u010Dase vybavenia obj. ignorovan\u00E9.", disabled: orderState !== 0 ? false : true }),
                                                React.createElement("p", { className: "mt-1" },
                                                    React.createElement("i", null,
                                                        React.createElement("small", null,
                                                            ...
                                                            React.createElement("strong", null, "info@tonap.sk"),
                                                            React.createElement("br", null),
                                                            React.createElement("br", null),
                                    ...
                                    React.createElement("div", { className: "row" },
                                        React.createElement("div", { className: "col-12" },
                                            React.createElement("div", { className: "form-group" },
                                                React.createElement("button", { type: "submit", className: "btn btn-primary", disabled: orderState > 0 ? (order.state > 1 ?
                                                        true : false) : true }, "Upravi\u0165 stav objedn\u00E1vky")))))))),
                    React.createElement("div", { className: "modal-footer" },
            ...
            React.createElement("div", { className: "mt-3 pb-3 position-relative", key: 2 },
                ...
                this.props.pageData ?
                    (this.props.pageData.length > 0 ?
                        [
                            React.createElement("table", { className: "table table-striped mb-5", key: 0 },
                                React.createElement("thead", null,
                                    React.createElement("tr", null,
                                        React.createElement("th", { scope: "col" }, "#"),
                                        React.createElement("th", { scope: "col" }, "\u010C\u00EDslo obj."),
                                        React.createElement("th", { scope: "col" }, "D\u00E1tum"),
                                        React.createElement("th", { scope: "col" }, "Stav obj."),
                                ...
                                React.createElement("tbody", null, this.props.pageData.map((item, i) => {
                                    ...
                                    return (React.createElement("tr", { key: i + 1 },
                                        ...
                                        React.createElement("td", null,
                                            React.createElement("span", { className: item.state > 0 ?
                                                    (item.state > 1 ?
                                                        "text-success font-weight-bold" : "text-warning font-weight-bold") : "text-danger font-weight-bold" }, state[item.state])),
        ...
        return [
            ...
            React.createElement("div", { key: 3, style: { minHeight: "calc(100vh - 100px)" } },
                ...
                React.createElement("div", { className: "container", style: { marginBottom: "100px" } },
                    ...
                    React.createElement(react_router_dom_1.Route, { exact: true, path: `${this.props.routeProps.match.url}`, render: () => (React.createElement(Orders_1.default, { itemsPerPage: this.props.itemsPerPage, orderManagerOpen: this.props.orderManagerOpen, getOrders: this.props.getOrders, handleChangeItemsPerPage: this.props.handleChangeItemsPerPage, handleChangeOrderDeliveryTime: this.props.handleChangeOrderDeliveryTime, handleChangeOrderState: this.props.handleChangeOrderState, handleChangePage: this.props.handleChangePage, handleOrderStateUpdate: this.props.handleOrderStateUpdate, handlePageData: this.props.handlePageData, handlePrintSummary: this.props.handlePrintSummary, handleReorder: this.props.handleReorder, handleSocketListener: this.props.handleSocketListener, handleSortOrderByState: this.props.handleSortOrderByState, handleSearchOrderByNum: this.props.handleSearchOrderByNum, order: this.props.order, orderDeliveryTime: this.props.orderDeliveryTime, orders: this.props.orders, orderState: this.props.orderState, oldOrderState: this.props.oldOrderState, orderSystem: this.props.orderSystem, page: this.props.page, pagesCount: this.props.pagesCount, pagesMax: this.props.pagesMax, pageData: this.props.pageData, printData: this.props.printData, products: this.props.products, showOrderManager: this.props.showOrderManager, showOrderSucess: this.props.showOrderSucess })) })),
